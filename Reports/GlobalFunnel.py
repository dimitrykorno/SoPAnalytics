...
from report_api.Utilities.Utils import time_count, sigma
    ...
    for os_str in os_list:
        ...
        Report.set_events_data(additional_parameters=None,
                               ...
                               events_list=[("Match3Events",),
                                            ("CityEvent", ["%StartGame%", '{"Quest%', "%InitGameState%",
        ...
        def flush_user_info():
            ...
            # Отвалы
            if Report.get_time_since_last_enter(user="previous", measure="day") >= days_left:
        ...
        writer = pd.ExcelWriter("QuestsFunnel " + os_str + " " + str(min_version) + ".xlsx")
