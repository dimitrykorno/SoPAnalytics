...
def new_report(os_list=["iOS"],
    ...
    for os_str in os_list:
        ...
        Report.set_events_data(additional_parameters=None,
                               ...
                               max_version=None,
                               countries_list=[],
                               events_list=[("Match3Events", "%FinishGame%"),
                                            ("CityEvent", ["%BuyDust%", "%UpdateBuilding%",
                                                           "%BuyDecoration%", "%Quest%",
        ...
        while Report.get_next_event():
            ...
            if Report.current_event.__class__.__name__ in {
                ...
                current_quest = Report.current_event.quest if Report.current_event.quest != "endgame" else current_quest
            ...
            # Покупка пыли
            if isinstance(Report.current_event, CityEventsBuyDust):
            ...
            if (buy_decor or restore) and Report.current_event.__class__.__name__ in {
                CityEventsBuyDecoration.__name__, CityEventsButton.__name__, CityEventsBuyDust.__name__,
            CityEventsStartGame.__name__,
                CityEventsInitGameState.__name__}:
                spent = 0
                if not Report.is_new_user():
                    if buy_decor:
                        spent = coins_decor - Report.current_user.game_coin
                        # print(Report.current_user.user_id, current_quest, spent)
                        coins_decor = 0
                    elif restore:
            ...
            if isinstance(Report.current_event, CityEventsBuyDecoration) and Report.current_event.status == "Success":
                buy_decor = True
            ...
            if isinstance(Report.current_event, CityEventsRestore):
            ...
            if isinstance(Report.current_event, Match3FinishGame):
        ...
        writer = pd.ExcelWriter(
            "Dust Dynamics/DustDynamics " + os_str + " " + str(min_version) + " " + os_str + ".xlsx")
        ...
        plt.savefig("Dust Dynamics/Dust Dynamics плат" + os_str + " " + str(min_version) + ".png")
        plt.show()
        ...
        plt.savefig("Dust Dynamics/Dust Dynamics не плат" + os_str + " " + str(min_version) + ".png")
        plt.show()
